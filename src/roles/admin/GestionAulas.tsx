...
import {
  Search, Plus, Edit, X, MapPin, Building2, Calendar, Grid, List, ChevronLeft, ChevronRight, Hash, FileText, ArrowLeftRight, Eye, Power, Trash2
} from 'lucide-react';
...
const GestionAulas = () => {
  ...
  const confirmDeleteAula = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        if (data.enUso) {
          showToast.error(
            `No se puede eliminar el aula "${aulaToDelete.nombre}" porque tiene ${data.cantidadAsignaciones} asignación(es) activa(s)`,
            darkMode
          );
        } else {
      ...
      await fetchAulas();
      showToast.success(`Aula "${aulaToDelete.nombre}" eliminada correctamente`, darkMode);
  ...
  return (
    <div style={{
      ...
      {/* Controles */}
      <GlassEffect variant="card" tint="neutral" intensity="light" style={{ marginBottom: 16, borderRadius: '0.375rem', padding: '0.5rem', boxShadow: 'none' }}>
        <div style={{
          display: 'flex',
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem', marginBottom: '0.25rem' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                    <div style={{
                      ...
                      <Building2 size={14} color={RedColorPalette.primary} />
                    </div>
                    <div>
                      <h3 style={{ color: textPrimary, margin: '0 0 0.15rem 0', fontSize: '0.75rem', fontWeight: 700 }}>
                        {aula.nombre}
                      </h3>
                      <span style={{
                        display: 'inline-flex',
                ...
                <div style={{
                  ...
                  <div style={{ display: 'grid', gap: '0.55rem' }}>
                    <div>
                      <div style={{ color: textMuted, fontSize: '0.6rem', marginBottom: '0.15rem', display: 'flex', alignItems: 'center', gap: '0.2rem', fontWeight: 600 }}>
                        <Hash size={11} />
                        Código
                      </div>
                      <div style={{ color: textPrimary, fontSize: '0.7rem', fontWeight: 600 }}>
                        {aula.codigo_aula}
                      </div>
                    </div>
                    <div>
                      ...
                      <div style={{ color: textPrimary, fontSize: '0.65rem' }}>
                  ...
                  <div style={{ display: 'grid', gap: '0.55rem' }}>
                    <div>
                      ...
                      <div style={{ color: textPrimary, fontSize: '0.7rem', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', marginTop: '0.35rem' }}>
                  ...
                  >
                    <Power size={13} color={aula.estado === 'activa' ? pick('#b91c1c', '#fca5a5') : pick('#047857', '#34d399')} />
                  ...
                  <button
                    ...
                    style={{
                      ...
                      gap: '0.375rem',
                      padding: '0.25rem 0.5rem',
                      background: pick('rgba(239,68,68,0.1)', 'rgba(239,68,68,0.18)'),
                      border: `0.0625rem solid ${pick('rgba(239,68,68,0.22)', 'rgba(239,68,68,0.32)')}`,
                      borderRadius: '0.5rem',
                      color: pick('#b91c1c', '#fca5a5'),
                      fontSize: '0.7rem',
                      fontWeight: 600,
                      cursor: 'pointer',
                      transition: 'background 0.2s ease'
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = pick('rgba(239,68,68,0.18)', 'rgba(239,68,68,0.25)');
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = pick('rgba(239,68,68,0.1)', 'rgba(239,68,68,0.18)');
                    }}
                  >
                    <Trash2 size={13} color={pick('#b91c1c', '#fca5a5')} />
                    Eliminar
                  </button>
                </div>
              </GlassEffect>
                    ...
                    {loading ? (
                      ...
                      aulasSorted.map((aula) => (
                        ...
                        >
                          ...
                          <td className="table-nombre-uppercase" style={{ padding: '0.25rem 0.5rem', verticalAlign: 'middle' }}>
                            <div style={{
                              fontWeight: '600',
                              color: textPrimary,
                              fontSize: '0.75rem',
            ...
            >
              <div style={{
                ...
                <p style={{
                  ...
                  ¿Está seguro que desea eliminar el aula <strong style={{ color: textPrimary }}>"{aulaToDelete.nombre}"</strong>?
                  <br />
