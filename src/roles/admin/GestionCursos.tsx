...
import { 
  Search, Plus, Edit, Eye, Trash2, X, Save, BookOpen, CheckCircle2, AlertCircle, Ban, PlayCircle, Lock, Unlock, Grid, List, ChevronLeft, ChevronRight, Sheet
} from 'lucide-react';
        ...
        <div className="responsive-filters">
          <div style={{ display: 'flex', flexDirection: isSmallScreen ? 'column' : 'row', gap: '0.75rem', alignItems: isSmallScreen ? 'stretch' : 'center', flex: 1, width: isSmallScreen ? '100%' : 'auto' }}>
            ...
            <div style={{ display: 'flex', gap: '0.375rem', alignItems: 'center' }}>
              <div style={{ display: 'flex', gap: '0.375rem', background: 'rgba(255,255,255,0.05)', borderRadius: '0.625rem', padding: '0.1875rem' }}>
                <button
