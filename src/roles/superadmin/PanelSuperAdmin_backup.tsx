...
const PanelSuperAdmin = () => {
  ...
  // Error de validación para la foto (inline en el formulario)
  const [fileError, setFileError] = useState<string | null>(null);
  // Error de validación para cédula (inline en el formulario)
  const [cedulaError, setCedulaError] = useState<string | null>(null);
  // Valor controlado para el input de cédula del modal de creación
  ...
  const handleCreateAdmin = async () => {
    try {
      ...
      // Validación estricta de cédula (Ecuador)
      ...
      // Validar tipo de archivo si se adjunta foto (opcional)
      if (fotoFile) {
      ...
      // Construir FormData para permitir subida de archivo
      ...
      fd.append('roleName', getVal('new-admin-role') || 'administrativo');
      ...
      ['new-admin-cedula','new-admin-nombre','new-admin-apellido','new-admin-email','new-admin-telefono','new-admin-fecha-nacimiento','new-admin-genero','new-admin-direccion','new-admin-foto-file','new-admin-password','new-admin-confirm']
        .forEach((id) => {
